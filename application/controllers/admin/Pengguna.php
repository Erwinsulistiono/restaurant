...
class Pengguna extends MY_Controller
{
	...
	function index()
	{
		$data = [
			...
			'data' => $this->M_crud->left_join('tbl_pengguna' , 'tbl_level_pos', 'tbl_pengguna.pengguna_level = tbl_level_pos.level_id'),
		];
		$this->render('pos/pengguna/v_pengguna', $data);
	}
