...
class Kitchen extends MY_Controller
{
  ...
  public function end_proses_kitchen()
  {
    ...
    $count_order_in_kitchen = $this->M_kitchen->get_all_order_by_id($trxId, $this->outlet);

    ($count_order_in_kitchen == 0) && $this->M_crud->update("tbl_trx_pos_$this->outlet", ['trx_kitchen_flg' => 'Y'], 'trx_id', $trxId);
  }
}
