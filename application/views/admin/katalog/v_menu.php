        ...
        <div class="card-body">
          <div class="row">
            <div class="col-xs-12">
              ...
              <br />
              <form class='form floating-label' action='<?= base_url('admin/menu/outlet') ?>' accept-charset='utf-8' method='post'>
                <div class="form-group">
                  <h2><select id="selectDb" name="outlet_id" class="form-control">
                      <option value="">&nbsp;</option>
