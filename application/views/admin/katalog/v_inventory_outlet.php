<div id="base">
  ...
  <div id="content">
    <section>
      ...
      <?php ($outlet_id == 'master') ? $visibility = '' : $visibility = 'hidden'; ?>
              ...
              <tbody>
                ...
                foreach ($data as $table_content) :
                  ...
                  <tr>
                    ...
                    <td class="text-right">
                      <span style="visibility:<?= $visibility ?>;">
                        <a href="#" class="btn btn-icon-toggle btn-raised" title="Tambah Stock Barang" data-toggle="modal" data-target="#modal_add_stock<?= $table_content['stock_id'] ?>"><i class="fa fa-plus" hidden></i></a>
                      </span>
                      <span style="visibility:<?= $visibility ?>;">
...
<!-- ============ MODAL BUAT STOCK =============== -->
<div class="modal fade" id="modal_buat_stock" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" role="form" method="post" action="<?= base_url("admin/inventory/simpan_inventory/${outlet_id}"); ?>" enctype="multipart/form-data">
...
<?php foreach ($data as $table_content) : ?>
  <div class="modal fade" id="modal_edit_stock<?= $table_content['stock_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close btn-raised text-danger" data-dismiss="modal" aria-hidden="true">
        ...
        <form class="form-horizontal" role="form" method="post" action="<?= base_url("admin/inventory/simpan_inventory/${outlet_id}"); ?>" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="form-group">
              <label class="col-sm-3 control-label">Kode Barang</label>
              <div class="col-sm-8">
                <input name="stock_id" type="hidden" class="form-control" value="<?= $table_content['stock_id'] ?>" required>
                <input name="stock_kode" class="form-control" value="<?= $table_content['stock_kode'] ?>" required>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label">Nama Barang</label>
              <div class="col-sm-8">
                <input name="stock_nama" class="form-control" value="<?= $table_content['stock_nama'] ?>" required>
              </div>
            </div>
            <div class="form-group">
              <label for="select13" class="col-sm-3 control-label">Kategori</label>
              <div class="col-sm-8">
                <input list="kategori" id="select13" name="stock_kat" class="form-control" value="<?= $table_content['stock_kat'] ?>" required />
                <datalist id="kategori">
                  <option value="">&nbsp;</option>
                  <?php $kat = "";
                  foreach ($data as $row) :
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">Stock</label>
              <div class="col-sm-8">
                <input name="stock_qty" class="form-control" value="<?= $table_content['stock_qty'] ?>" required>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label">Minimum Stock Alert</label>
              <div class="col-sm-8">
                <input name="stock_min_qty" class="form-control" value="<?= $table_content['stock_min_qty']; ?>" required>
              </div>
            </div>
            <div class="form-group">
              <label for="select13" class="col-sm-3 control-label">Satuan</label>
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">Harga / Satuan</label>
              <div class="col-sm-8">
                <input name="stock_harga" type="number" class="form-control" value="<?= floatval($table_content['stock_harga']); ?>" required>
              </div>
            </div>
          </div>
          <div class="modal-footer">
...
<!---- MODAL TAMBAH STOCK ----->
<?php foreach ($data as $table_content) : ?>
  <div class="modal fade" id="modal_add_stock<?= $table_content['stock_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close btn-raised text-danger" data-dismiss="modal" aria-hidden="true">
        ...
        <form class="form-horizontal" role="form" method="post" action="<?= base_url("admin/inventory/tambah_inventory/${outlet_id}"); ?>" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="form-group">
              <label class="col-sm-3 control-label">Nama Barang</label>
              <div class="col-sm-8">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="hidden" name="stock_id" class="form-control" value="<?= $table_content['stock_id']; ?>" required>
                <input name="stock_qty" class="form-control" required>
              </div>
            </div>
            <div class="modal-footer">
...
<?php foreach ($data as $table_content) : ?>
  <div class="modal fade" id="modal_transfer_stock<?= $table_content['stock_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close btn-raised text-danger" data-dismiss="modal" aria-hidden="true">
        ...
        <form class="form-horizontal" role="form" method="post" action="<?= base_url("admin/inventory/transfer_inventory/${outlet_id}"); ?>" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="form-group">
              <label class="col-sm-3 control-label">Nama Barang</label>
              <div class="col-sm-8">
