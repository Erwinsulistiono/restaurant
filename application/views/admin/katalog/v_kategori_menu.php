  ...
  <div id="content">
    <section>
      ...
      <section class="card style-default-bright" style="margin-top:0px;">
        <p><a href="#" class="btn btn-primary btn-raised" data-toggle="modal" data-target="#modal_add_kategori"><span
              class="fa fa-plus"></span> Tambah Kategori</a></p>
                  ...
                  <tr>
                    ...
                    <td class="text-right">
                      <a href="#" class="btn btn-icon-toggle btn-raised" title="Edit row" data-toggle="modal"
                        data-target="#modal_edit_kategori<?= $table_content['kategori_id']; ?>"><i
                          class="fa fa-pencil"></i></a>
                      <a href="<?= base_url('admin/katalog/hapus_kategori_menu/') . $table_content['kategori_id']; ?>"
...
<!-- ============ MODAL ADD PELANGGAN =============== -->
<div class="modal fade" id="modal_add_kategori" tabindex="-1" role="dialog" aria-labelledby="largeModal"
  aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" role="form" method="post"
        action="<?= base_url('admin/katalog/simpan_kategori_menu'); ?>" enctype="multipart/form-data">
...
<div class="modal fade" id="modal_edit_kategori<?= $table_content['kategori_id']; ?>" tabindex="-1" role="dialog"
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <input type="text" name="kategori_nama" value="<?= $table_content['kategori_nama']; ?>"
