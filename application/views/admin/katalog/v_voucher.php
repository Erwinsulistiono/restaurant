          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <div class="input-group input-daterange">
                <input type="date" name="voucher_periode_awal" class="datepicker input-group date form-control" id="demo-date-range">
                <span class="input-group-addon">to</span>
                <input type="date" name="voucher_periode_akhir" class="datepicker input-group date form-control" id="demo-date-range">
