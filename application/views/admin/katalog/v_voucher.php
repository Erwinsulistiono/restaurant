  ...
  <div id="content">
    <section>
      ...
      <section class="card style-default-bright" style="margin-top:0px;">
        <p><a href="#" class="btn btn-primary btn-raised" data-toggle="modal" data-target="#modal_add_voucher"><span
              class="fa fa-plus"></span> Tambah voucher</a></p>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <a href="#" class="btn btn-icon-toggle btn-raised" title="Edit row" data-toggle="modal"
                      data-target="#modal_edit_voucher<?= $table_content['voucher_id']; ?>"><i
                        class="fa fa-pencil"></i></a>
                    <a href="<?= base_url('admin/katalog/hapus_voucher/') . $table_content['voucher_id']; ?>"
                      onclick="return confirm('Apakah anda yakin menghapus voucher <?= $table_content['voucher_nama'] ?>?')"
...
<!-- ============ MODAL ADD VOUCHER =============== -->
<div class="modal fade" id="modal_add_voucher" tabindex="-1" role="dialog" aria-labelledby="largeModal"
  aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" role="form" method="post" action="<?= base_url('admin/katalog/simpan_voucher'); ?>"
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label">Nama voucher</label>
            <div class="col-sm-8">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label">Syarat T&C</label>
            <div class="col-sm-8">
...
<div class="modal fade" id="modal_edit_voucher<?= $table_content['voucher_id']; ?>" tabindex="-1" role="dialog"
