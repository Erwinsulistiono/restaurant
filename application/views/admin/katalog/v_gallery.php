...
<div id="base">
	...
	<section>
		...
		<p><a href="#" class="btn btn-primary btn-raised" data-toggle="modal" data-target="#modal_add_gallery"><span
				class="fa fa-plus"></span> Tambah Gallery</a></p>
			...
			<table class="table table-hover" id="datatable1">
				...
				<tr>
					<td><img style="width:80px;height:80px;" class="img-thumbnail width-1"
						src="<?= base_url() . 'assets/galeries/' . $table_content['galeri_gambar']; ?>" alt="" /></td>
					...
					<a href="#" class="btn btn-icon-toggle btn-raised" title="Edit row" data-toggle="modal"
						data-target="#modal_edit_gallery<?= $table_content['galeri_id']; ?>"><i
						class="fa fa-pencil"></i></a>
					<a href="<?= base_url('admin/katalog/hapus_gallery') . $table_content['galeri_id']; ?>"
						onclick="return confirm('Apakah anda yakin menghapus <?= $table_content['galeri_judul'] ?>?')"
						class="btn btn-icon-toggle text-danger btn-raised" title="Delete row"><i class="fa fa-trash-o"></i></a>
					</td>
				</tr>
				<?php endforeach; ?>
				</tbody>
...
<!-- ============ MODAL ADD PELANGGAN =============== -->
<div class="modal fade" id="modal_add_gallery" tabindex="-1" role="dialog" aria-labelledby="largeModal"
	aria-hidden="true">
	...
	<div class="modal-content">
		...
		action="<?= base_url() . 'admin/katalog/simpan_gallery' ?>" enctype="multipart/form-data">
		<div class="modal-body">
			...
			<div class="col-sm-8">
				<textarea name="galeri_deskripsi" id="textarea13" class="form-control" rows="3" placeholder=""
				required></textarea>
			</div>
			</div>
			<div class="form-group">
...
<div class="modal fade" id="modal_edit_gallery<?= $table_content['galeri_id']; ?>" tabindex="-1" role="dialog"
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<div class="col-sm-8">
				...
				<input type="text" name="galeri_judul" value="<?= $table_content['galeri_judul']; ?>"
			...
			<div class="col-sm-8">
				<textarea name="galeri_deskripsi" id="textarea13" class="form-control" rows="3" placeholder=""
				required><?= $table_content['galeri_deskripsi']; ?></textarea>
			</div>
			</div>
			<div class="form-group">
			<label class="col-sm-3 control-label">Gambar</label>
