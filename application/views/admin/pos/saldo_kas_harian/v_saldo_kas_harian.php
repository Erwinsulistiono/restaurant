...
<div id="base">
	...
	<section>
		...
		<p><a href="<?= base_url('admin/pos/pilih_saldo/'); ?>" class="btn btn-primary"><span class="fa fa-arrow-left"></span>
				Kembali</a>
			<a href="#" class="btn btn-primary btn-raised" data-toggle="modal" data-target="#modal_add_saldo"><span
				class="fa fa-plus"></span> Tambah Saldo</a>
		...
		<div class="section-body">
			...
			<table class="table table-hover" id="datatable1">
				...
				<tr>
					...
					<td class="text-right">
					<a href="#" class="btn btn-icon-toggle btn-raised" title="Input Saldo Akhir" data-toggle="modal"
						data-target="#modal_edit_saldo<?= $table_content['kas_id']; ?>"><i class="fa fa-pencil"></i></a>
					</td>
				</tr>
				<?php endforeach; ?>
...
<!-- ============ MODAL ADD SALDO =============== -->
<div class="modal fade" id="modal_add_saldo" tabindex="-1" role="dialog" aria-labelledby="largeModal"
	aria-hidden="true">
	...
	<div class="modal-content">
		<div class="modal-header">
			...
			<form class="form-horizontal" role="form" method="post" action="<?= base_url('admin/pos/simpan_saldo/') . $pengguna_kasir.'/'.$tgl_awal.'/'.$tgl_akhir.'/'.$outlets; ?>"
			...
			<div class="modal-body">
				...
				<div class="col-sm-8">
					<input type="text" name="kas_saldo_awal" class="form-control"  required>
				</div>
				</div>
...
<div class="modal fade" id="modal_edit_saldo<?= $table_content['kas_id']; ?>" tabindex="-1" role="dialog"
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<div class="col-sm-8">
				...
				<input type="text" name="kas_nm_outlet" value="<?= $table_content['out_nama']; ?>" class="form-control"
					required>
			</div>
			</div>
			...
			<label for="textarea13" class="col-sm-3 control-label">Nama Kasir</label>
			<div class="col-sm-8">
				<input type="hidden" name="kas_nm_kasir" value="<?= $table_content['pengguna_id']; ?>" id="textarea13"
				class="form-control" required readonly></input>
				<input value="<?= $table_content['pengguna_nama']; ?>" id="textarea13" class="form-control" required
				readonly></input>
			</div>
			</div>
			...
			<div class="col-sm-8">
				<input name="kas_saldo_awal" value="<?= number_format($table_content['kas_saldo_awal'], 0, ',', '.'); ?>"
				id="textarea13" class="form-control" required></input>
			</div>
			</div>
			...
			<div class="col-sm-8">
				<input name="kas_saldo_akhir" value="<?= number_format($table_content['kas_saldo_akhir']); ?>"
				id="textarea13" class="form-control" required></input>
			</div>
			</div>
