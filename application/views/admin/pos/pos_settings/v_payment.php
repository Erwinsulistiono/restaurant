  ...
  <div id="content">
    <section>
      ...
      <section class="card style-default-bright" style="margin-top:0px;">
        <p><a href="#" class="btn btn-primary btn-raised" data-toggle="modal" data-target="#modal_add_payment"><span class="fa fa-plus"></span> Tambah Tipe Pembayaran</a></p>
            ...
            <table class="table table-hover" id="datatable1">
              ...
              <tbody>
                ...
                foreach ($data as $table_content) :
                  $payment_qrcode = $table_content['payment_qrcode'];
                  $payment_id = $table_content['payment_id'];
                  $no++ ?>
                  <tr>
                    <td><?= $no; ?></td>
                    <td>
                      <?php if ($payment_qrcode) : ?>
                        <img style="width: 80px;height: 80px;" class="img-thumbnail width-1" src="<?= base_url("assets/img/$payment_qrcode"); ?>">
                      <?php endif ?>
                    </td>
...
<!-- ============ MODAL ADD PAYMENT =============== -->
<div class="modal fade" id="modal_add_payment" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" role="form" method="post" action="<?= base_url('admin/pos/simpan_payment'); ?>" enctype="multipart/form-data">
...
foreach ($data as $table_content) :
?>
  <div class="modal fade" id="modal_edit_payment<?= $table_content['payment_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                ...
                <input type="hidden" name="old_payment_qrcode" value="<?= $table_content['payment_qrcode']; ?>" class="form-control">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">Nama Payment</label>
              <div class="col-sm-8">
                <input name="payment_nama" value="<?= $table_content['payment_nama']; ?>" class="form-control" required>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label">No Rekening / No. HP</label>
              <div class="col-sm-8">
                <input name="payment_norek" value="<?= $table_content['payment_norek']; ?>" class="form-control" required>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label">Bank</label>
              <div class="col-sm-8">
                <input name="payment_bank" value="<?= $table_content['payment_bank']; ?>" class="form-control" required>
              </div>
            </div>
