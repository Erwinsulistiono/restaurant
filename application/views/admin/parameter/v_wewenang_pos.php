  ...
  <div id="content">
    <section>
      ...
      <section class="card style-default-bright" style="margin-top:0px;">
        <p><a href="#" class="btn btn-primary btn-raised" data-toggle="modal" data-target="#modal_add_wewenang"><span
              ...
              <tbody>
                ...
                <tr>
                  <form name="form" method="post"
                    action="<?= base_url() . 'admin/parameter/reset_wewenang_pos/' . $table_content['level_id'] . '/' . $table_content['level_desc']; ?>">
                    <td><?= $no; ?></td>
                    ...
                    <td class="text-right">
                      ...
                      <a href="<?= base_url() . '/admin/parameter/hapus_wewenang_pos/' . $table_content['level_id'] ?>"
                        class="btn btn-icon-toggle btn-raised" title="Delete row"><i class="fa fa-trash-o text-danger"></i></a>
                    </td>
                  </form>
                </tr>
                <?php endforeach; ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" role="form" name="form" method="post"
        action="<?= base_url() . 'admin/parameter/reset_wewenang_pos'; ?>">
