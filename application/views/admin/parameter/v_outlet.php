  ...
  <div id="content">
    <section>
      ...
      <section class="card style-default-bright" style="margin-top:0px;">
        <p><a href="#" class="btn btn-primary btn-raised" data-toggle="modal" data-target="#modal_add_outlet"><span
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <a href="#" class="btn btn-icon-toggle btn-raised" title="Edit row" data-toggle="modal"
                      data-target="#modal_edit_outlet<?= $table_content['out_id']; ?>"><i class="fa fa-pencil"></i></a>
                    <a href="<?= base_url('admin/parameter/hapus_outlet/') . $table_content['out_id']; ?>"
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <input name="out_kode" value="<?= $table_content['out_kode']; ?>" class="form-control"
                required>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label">Nama Outlet</label>
            <div class="col-sm-8">
              <input name="out_nama" value="<?= $table_content['out_nama']; ?>" class="form-control"
                required>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label">Alamat</label>
            <div class="col-sm-8">
              <input name="out_alamat" value="<?= $table_content['out_alamat']; ?>" class="form-control" 
                required>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input name="out_telp" value="<?= $table_content['out_telp']; ?>" class="form-control"
                required>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input name="out_email" value="<?= $table_content['out_email']; ?>" class="form-control"
                required>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input name="out_nm_pic" value="<?= $table_content['out_nm_pic']; ?>" class="form-control"
                required>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label">Struk Notes</label>
            <div class="col-sm-8">
              <input name="out_notes" value="<?= $table_content['notes_receipt']; ?>" class="form-control"
                required>
            </div>
          </div>
