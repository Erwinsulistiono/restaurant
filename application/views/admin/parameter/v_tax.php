  ...
  <div id="content">
    <section>
      ...
      <section class="card style-default-bright" style="margin-top:0px;">
        <p><a href="#" class="btn btn-primary btn-raised" data-toggle="modal" data-target="#modal_add_tax"><span
              class="fa fa-plus"></span> Tax</a></p>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <a href="#" class="btn btn-icon-toggle btn-raised" title="Edit row" data-toggle="modal"
                      data-target="#modal_edit_tax<?= $table_content['tax_id']; ?>"><i class="fa fa-pencil"></i></a>
                    <a href="<?= base_url(); ?>admin/parameter/hapus_tax/<?= $table_content['tax_id']; ?>"
...
<div class="modal fade" id="modal_add_tax" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" role="form" method="post" action="<?= base_url('admin/parameter/simpan_tax'); ?>"
...
<div class="modal fade" id="modal_edit_tax<?= $table_content['tax_id']; ?>" tabindex="-1" role="dialog"
      ...
      <form class="form-horizontal" role="form" method="post" action="<?= base_url('admin/parameter/simpan_tax'); ?>"
        ...
        <div class="modal-body">
          <div class="form-group">
            <label  class="col-sm-3 control-label">Nama Pajak</label>
            <div class="col-sm-8">
              <input name="tax_nm" value="<?= $table_content['tax_nm']; ?>" class="form-control" 
                required>
            </div>
          </div>
          <div class="form-group">
