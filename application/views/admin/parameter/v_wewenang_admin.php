              ...
              <tbody>
                ...
                <tr>
                  <form name="form" method="post"
                    action="<?= base_url() . 'admin/parameter/reset_wewenang/' . $table_content['level_id'] . '/' . $table_content['level_desc']; ?>">
                    <td><?= $no; ?></td>
                    ...
                    <td class="text-right">
                      ...
                      <a href="<?= base_url() . '/admin/parameter/hapus_wewenang/' . $table_content['level_id'] ?>"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" role="form" name="form" method="post"
        action="<?= base_url() . 'admin/parameter/reset_wewenang'; ?>">
