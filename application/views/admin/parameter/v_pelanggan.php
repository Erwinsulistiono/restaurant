                ...
                foreach ($data as $table_content) :
                  ...
                  <tr>
                    ...
                    <td class="text-right">
                      ...
                      <a href="<?= base_url("admin/parameter/reset_pelanggan/$plg_id"); ?>" onclick="return confirm('Apakah anda yakin reset password <?= $table_content['plg_nama']; ?> ?')" class="btn btn-icon-toggle btn-raised" title="Reset Password"><i class="fa fa-refresh"></i></a>
