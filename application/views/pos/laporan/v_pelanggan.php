              ...
              <tbody>
                ...
                foreach ($data as $table_content) :
                  ...
                  <tr>
                    ...
                    <td class="text-right">
                      <a href="#" class="btn btn-icon-toggle btn-raised" title="lihat pesanan" data-toggle="modal" data-target="#modal_view_pesanan<?= str_replace(' ', '', $table_content['trx_cust']); ?>"><i class="fa fa-eye"></i></a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
...
<?php foreach ($data as $table_content) : ?>
  <div class="modal fade" id="modal_view_pesanan<?= str_replace(' ', '', $table_content['trx_cust']); ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
