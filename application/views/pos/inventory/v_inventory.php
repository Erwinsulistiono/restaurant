            ...
            <table class="table table-hover" id="datatable1">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td> <?= floatval($table_content['stock_qty']) . ' (' . $table_content['stock_satuan'] . ')'; ?> </td>
                </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
...
<div class="modal fade" id="modal_edit_stok<?= $table_content['stock_id']; ?>" tabindex="-1" role="dialog"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" role="form" method="post"
        action="<?= base_url('admin/inventory/simpan_inventory/') . $this->session->userdata('pengguna_outlet'); ?>" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              value="<?= $table_content['stock_kat'] ?>" readonly/>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input name="stok_brg" class="form-control" value="<?= number_format($table_content['stock_qty']); ?>"
                required>
            </div>
          </div>
        </div>
